...
@Component({
  selector: 'app-comment-form-plan',
  templateUrl: './comment-form-plan.component.html',
  styleUrl: './comment-form-plan.component.scss'
})
export class CommentFormPlanComponent implements OnInit{
  botones = false;
  user!: UserProfile;
